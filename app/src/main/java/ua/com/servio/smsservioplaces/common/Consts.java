package ua.com.servio.smsservioplaces.common;
...
public final class Consts {
    ...
    public final static String CONNECT_SERVER_URL = "http://sms.servio.support:32892";
    public final static String CONNECT_PATTERN_URL = "GetPlaces";
